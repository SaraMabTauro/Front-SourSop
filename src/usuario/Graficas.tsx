...
//       try {
//         setLoading(true);
//         const [tendenciaRes, comparacionRes, dispersionRes, estadisticasRes] = await Promise.all([
//           axios.get<DataPoint[]>('/api/tendencia-central'),
//           axios.get<DataPoint[]>('/api/comparacion-central'),
//           axios.get<DispersionData[]>('/api/dispersion'),
//           axios.get<{ desviacion: number; media: number; varianza: number }>('/api/estadisticas'),
//         ]);
